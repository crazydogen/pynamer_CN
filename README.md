...
There are also some common first names used by most Chinese people. Pynamer_CN is written with simple python3 codes use if-elif-else structure. Surprisingly, pynamer_CN is also supporting python2.
